...
\chapter{Úvod}
\input{Text/0.1.Uvod.tex}

\chapter{Teoretická část}
\input{Text/1.1.Kontrast.tex}
\input{Text/2.1.MoznostiPrekladu.tex}


\chapter{Praktická část}
\input{Text/5.1.ProblemNacitaniDicom.tex}
\input{Text/2.2.MultiPlanarniRekonstrukce.tex}
...
% \input{vnitrek_priloha1.tex} % pøíloha 1: vloená z externího souboru
% \input{vnitrek_priloha2.tex} % pøíloha 2: vloená z externího souboru
